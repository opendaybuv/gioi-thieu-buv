...
function ad(a,b,c,d){var e=$c(a,b,d);Array.isArray(e)||(e=Qc);var f=Dc(e);f&1||Fc(e);G(a.s)?c&1||(Bc(e,2),Object.freeze(e)):e===Qc||!(c&1&&c&2)&&f&2?(e=Fc(Array.prototype.slice.call(e)),I(a,b,e,d)):!(c&2)&&f&16&&Ic(e);return e}
...
n.clone=function(){var a=Wc(this.s,Zc,Mc);Hc(a);md=a;a=new this.constructor(a);md=null;pd(a,this);return a};
...
;var Ud={};function Xd(a){this.i=a||{cookie:""}}
...
var Yd=new Xd("undefined"==typeof document?null:document);function Zd(a){return!!Ud.FPA_SAMESITE_PHASE2_MOD||!(void 0===a||!a)}
...
function Rf(a,b){if(0==a.i)if(a.l){var c=a.l;if(c.j){for(var d=0,e=null,f=null,g=c.j;g&&(g.l||(d++,g.i==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.i&&1==d?Rf(c,b):(f?(d=f,d.next==c.m&&(c.m=d),d.next=d.next.next):Sf(c),pg(c,e,3,b)))}a.l=null}else Lf(a,3,b)}
...
Kf.prototype.D=function(){for(var a;a=Sf(this);)pg(this,a,this.i,this.A);this.o=!1};
function pg(a,b,c,d){if(3==c&&b.onRejected&&!b.l)for(;a&&a.u;a=a.l)a.u=!1;if(b.i)b.i.l=null,ug(b,c,d);else try{b.l?b.j.call(b.context):ug(b,c,d)}catch(e){vg.call(null,e)}df(Nf,b)}
...
var h=""+Yn(a.j,"host")+("/embed/"+Yn(a.j,"videoId"))+"?"+Tb(g);ao.yt_embedsEnableUaChProbe?On().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Ld(l.href).toString();xd(c,Md(k));return k}):ao.yt_embedsEnableIframeSrcWithIntent?xd(c,Md(h)):c.src=h;
return c}
...
Gn(Z)}if(Ln.length)for(var Y=0;Y<Ln.length&&!(Aa=En(Ln[Y],"params.context."+Y,q,Aa),500<=Aa);Y++);navigator.vendor&&!q.hasOwnProperty("vendor")&&(q["device.vendor"]=navigator.vendor);var S={message:z,name:H,lineNumber:N,fileName:nb,stack:uc,params:q,sampleWeight:1},Oj=Number(u.columnNumber);isNaN(Oj)||(S.lineNumber=S.lineNumber+":"+Oj);if("IGNORED"===u.level)m=0;else a:{for(var Pj=An(),Qj=t(Pj.X),Tf=Qj.next();!Tf.done;Tf=Qj.next()){var Rj=Tf.value;if(S.message&&S.message.match(Rj.dc)){m=Rj.weight;
break a}}for(var Sj=t(Pj.V),Uf=Sj.next();!Uf.done;Uf=Sj.next()){var Tj=Uf.value;if(Tj.pb(S)){m=Tj.weight;break a}}m=1}S.sampleWeight=m;for(var Uj=t(vn),Vf=Uj.next();!Vf.done;Vf=Uj.next()){var Wf=Vf.value;if(Wf.Ca[S.name])for(var Vj=t(Wf.Ca[S.name]),Xf=Vj.next();!Xf.done;Xf=Vj.next()){var Wj=Xf.value,Vd=S.message.match(Wj.regexp);if(Vd){S.params["params.error.original"]=Vd[0];for(var Yf=Wj.groups,Xj={},Zb=0;Zb<Yf.length;Zb++)Xj[Yf[Zb]]=Vd[Zb+1],S.params["params.error."+Yf[Zb]]=Vd[Zb+1];S.message=Wf.Ma(Xj);
...
wa);if(R("record_app_crashed_web")&&0===Kn&&1===wa.sampleWeight)if(Kn++,R("errors_via_jspb")){var Zf=new nh;I(Zf,1,1);if(!R("report_client_error_with_app_crash_ks")){var Zj=new ih;I(Zj,1,wa.message);var ak=new jh;J(ak,ih,3,Zj);var bk=new kh;J(bk,jh,5,ak);var ck=new lh;J(ck,kh,9,bk);J(Zf,lh,4,ck)}var oo=Zf,dk=new qh;gd(dk,nh,20,rh,oo);tn(dk)}else{var ek={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(ek.systemHealth={crashData:{clientError:{logMessage:{message:wa.message}}}});
un("appCrashed",ek)}Jn++}else"WARNING"===h&&Bn.ha("handleWarning",wa);if(R("kevlar_gel_error_routing"))a:{var $f=void 0,ag=void 0,Jc=h,P=wa;if(R("errors_via_jspb")){if(Nn())ag=void 0;else{var $b=new fh;I($b,1,P.stack);P.fileName&&I($b,4,P.fileName);var Oa=P.lineNumber&&P.lineNumber.split?P.lineNumber.split(":"):[];0!==Oa.length&&(1!==Oa.length||isNaN(Number(Oa[0]))?2!==Oa.length||isNaN(Number(Oa[0]))||isNaN(Number(Oa[1]))||(I($b,2,Number(Oa[0])),I($b,3,Number(Oa[1]))):I($b,2,Number(Oa[0])));var vb=
new ih;I(vb,1,P.message);I(vb,3,P.name);I(vb,6,P.sampleWeight);"ERROR"===Jc?I(vb,2,2):"WARNING"===Jc?I(vb,2,1):I(vb,2,0);var bg=new gh;I(bg,1,!0);gd(bg,fh,3,hh,$b);var wb=new ch;I(wb,3,window.location.href);for(var fk=Q("FEXP_EXPERIMENTS",[]),cg=0;cg<fk.length;cg++){var gk=wb,po=fk[cg];Rc(gk);ad(gk,5,2,!1).push(po)}var dg=Ch();if(!Dh()&&dg)for(var hk=t(Object.keys(dg)),xb=hk.next();!xb.done;xb=hk.next()){var ik=xb.value,eg=new eh;I(eg,1,ik);eg.setValue(String(dg[ik]));id(wb,4,eh,eg)}var fg=P.params;
if(fg){var jk=t(Object.keys(fg));for(xb=jk.next();!xb.done;xb=jk.next()){var kk=xb.value,gg=new eh;I(gg,1,"client."+kk);gg.setValue(String(fg[kk]));id(wb,4,eh,gg)}}var lk=Q("SERVER_NAME"),mk=Q("SERVER_VERSION");if(lk&&mk){var hg=new eh;I(hg,1,"server.name");hg.setValue(lk);id(wb,4,eh,hg);var ig=new eh;I(ig,1,"server.version");ig.setValue(mk);id(wb,4,eh,ig)}var Wd=new jh;J(Wd,ch,1,wb);J(Wd,gh,2,bg);J(Wd,ih,3,vb);ag=Wd}var nk=ag;if(!nk)break a;var ok=new qh;gd(ok,jh,163,rh,nk);tn(ok)}else{if(Nn())$f=
void 0;else{var Kc={stackTrace:P.stack};P.fileName&&(Kc.filename=P.fileName);var Pa=P.lineNumber&&P.lineNumber.split?P.lineNumber.split(":"):[];0!==Pa.length&&(1!==Pa.length||isNaN(Number(Pa[0]))?2!==Pa.length||isNaN(Number(Pa[0]))||isNaN(Number(Pa[1]))||(Kc.lineNumber=Number(Pa[0]),Kc.columnNumber=Number(Pa[1])):Kc.lineNumber=Number(Pa[0]));var jg={level:"ERROR_LEVEL_UNKNOWN",message:P.message,errorClassName:P.name,sampleWeight:P.sampleWeight};"ERROR"===Jc?jg.level="ERROR_LEVEL_ERROR":"WARNING"===
Jc&&(jg.level="ERROR_LEVEL_WARNNING");var qo={isObfuscated:!0,browserStackInfo:Kc},ac={pageUrl:window.location.href,kvPairs:[]};Q("FEXP_EXPERIMENTS")&&(ac.experimentIds=Q("FEXP_EXPERIMENTS"));var kg=Ch();if(!Dh()&&kg)for(var pk=t(Object.keys(kg)),yb=pk.next();!yb.done;yb=pk.next()){var qk=yb.value;ac.kvPairs.push({key:qk,value:String(kg[qk])})}var lg=P.params;if(lg){var rk=t(Object.keys(lg));for(yb=rk.next();!yb.done;yb=rk.next()){var sk=yb.value;ac.kvPairs.push({key:"client."+sk,value:String(lg[sk])})}}var tk=
Q("SERVER_NAME"),uk=Q("SERVER_VERSION");tk&&uk&&(ac.kvPairs.push({key:"server.name",value:tk}),ac.kvPairs.push({key:"server.version",value:uk}));$f={errorMetadata:ac,stackTrace:qo,logMessage:jg}}var vk=$f;if(!vk)break a;un("clientError",vk)}if("ERROR"===Jc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(rn(!0),!R("web_fp_via_jspb_and_json")))break c;rn()}else{if(R("web_fp_via_jspb")&&(rn(!0),!R("web_fp_via_jspb_and_json")))break b;rn()}}if(!R("suppress_error_204_logging")){var zb=
wa,Lc=zb.params||{},ab={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,level:h,"client.name":Lc.name},postParams:{url:Q("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Lc.version&&(ab["client.version"]=Lc.version);if(ab.postParams){zb.stack&&(ab.postParams.stack=zb.stack);for(var wk=t(Object.keys(Lc)),mg=wk.next();!mg.done;mg=wk.next()){var xk=mg.value;ab.postParams["client."+xk]=Lc[xk]}var ng=Ch();if(ng)for(var yk=t(Object.keys(ng)),
og=yk.next();!og.done;og=yk.next()){var zk=og.value;ab.postParams[zk]=ng[zk]}var Ak=Q("SERVER_NAME"),Bk=Q("SERVER_VERSION");Ak&&Bk&&(ab.postParams["server.name"]=Ak,ab.postParams["server.version"]=Bk)}oi(Q("ECATCHER_REPORT_HOST","")+"/error_204",ab)}try{Hn.add(wa.message)}catch(vo){}In++}}}}}else throw Yb;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function jo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
